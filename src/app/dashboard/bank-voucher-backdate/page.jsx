...
import { PromptModal } from "../cash-voucher/PromptModal";
  ...
  return (
    <div className="h-screen overflow-y-auto bg-[#EEEEF1] ">
      <div className="transition-all  duration-300 ease-in-out ">
       <Navbar pageTitle="BANK VOUCHER BACK DATE ENTRY" menu="Transaction Entry" />
        ...
        <div className="p-6 sm:px-4 md:px-6 py-1">
          <div className="bg-white rounded-lg shadow-sm p-3 sm:p-4 md:p-6">
            ...
            <Cardheader
              ...
              title2="BUDAUN"
              head="BANK VOUCHER BACK DATE ENTRY"
            />
            <div>
              <Accordion
                type="multiple"
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2  gap-4 mb-8">
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <div className="flex flex-col">
                            ...
                            <textarea
                              className="w-full h-28 custom-input "
                        ...
                        <div className="flex flex-col">
                          ...
                          <div className="flex flex-col">
                            ...
                            <textarea
                              className="w-full h-16 custom-input"
                              placeholder="description"
                              value={enclosures}
