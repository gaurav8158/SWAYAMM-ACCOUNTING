...
const TdsChallanEntry = ({ isCollapsed = false, activeItem, toggleMobileSidebar = () => { } }) => {
    ...
    const [personResponsible, setPersonResponsible] = useState('SYSTEM ADMINISTRATOR');
    ...
    return (
        <>
            <div className={`${isCollapsed ? 'md:ml-20' : 'md:ml-72'} transition-all duration-300 ease-in-out min-h-screen bg-[#EEEEF1]`}>
                <Navbar pageTitle={pageTitles.tdschallanentry} toggleMobileSidebar={toggleMobileSidebar} />
                ...
                <div className='p-4 sm:p-6'>
                    ...
                    <div className='bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6'>
                        ...
                        <div className="text-center mb-4 sm:mb-6">
                            ...
                            <h1 className="text-xl font-bold text-gray-800 underline mt-4">CHALLAN</h1>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6 items-center">
                            ...
                            {/* Ref No. From */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">Ref No. From</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={refNoFrom}
                            ...
                            {/* Ref No. To */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">To</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={refNoTo}
                            ...
                            {/* Challan No. */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">Challan No.</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={challanNo}
                            ...
                            {/* CHQ NO */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">CHQ NO</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={chqNo}
                            ...
                            {/* Under Sec. */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">Under Sec.</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={underSec}
                            ...
                            <div className="md:col-span-3">
                                <label className="block text-gray-700 font-medium mb-2 text-sm">Bank Br Code</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={bankBrCode}
                            ...
                            {/* Account */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">Account</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={account}
                            ...
                            <div className="md:col-span-3 grid grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-gray-700 font-medium mb-2 text-sm">Ledger</label>
                                    <input
                                        type="text"
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                        value={ledger}
                                ...
                                <div>
                                    <label className="block text-gray-700 font-medium mb-2 text-sm">Challan Amt</label>
                                    <input
                                        type="text"
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                        value={challanAmt}
                            ...
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">Vch Type</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={vchType}
                            ...
                            <div className="md:col-span-3 grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="block text-gray-700 font-medium mb-2 text-sm">Vch Amount</label>
                                    <input
                                        type="text"
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                        value={vchAmount}
                        ...
                        {/* Entered By Section */}
                        <div className="mb-6">
                            <label className="block text-gray-700 font-medium mb-2 text-sm">Entered By</label>
                            <div className="flex gap-2 items-center">
                                <span className="text-sm text-gray-700 font-medium">Person Responsible</span>
                                {/* SA Input */}
                                <input
                                    type="text"
...
export default TdsChallanEntry;
