...
const BankStatementEntry = ({ isCollapsed = false, activeItem, toggleMobileSidebar = () => { } }) => {
    ...
    return (
        <>
            <div className={`${isCollapsed ? 'md:ml-20' : 'md:ml-72'} transition-all duration-300 ease-in-out min-h-screen bg-[#EEEEF1]`}>
                <Navbar pageTitle={pageTitles.bankstatemententry} toggleMobileSidebar={toggleMobileSidebar} />
                ...
                <div className='p-4 sm:p-6'>
                    ...
                    <div className='bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6'>
                        ...
                        <div className="text-center mb-4 sm:mb-6">
                            ...
                            <h1 className="text-xl font-bold text-gray-800 underline mt-4">Bank Statement Entry</h1>
                        </div>
                        ...
                        <div className="mb-6 p-4 border border-gray-300 rounded-lg">
                            <label className="block text-gray-700 font-medium mb-3 text-sm">VIDE</label>
                            <div className="flex flex-wrap gap-4">
                                {['CHEQUE', 'DD', 'PAY ORDER', 'TPO/TT/MT', 'RTGS', 'LC'].map((type) => (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            {/* Bank Statement Date */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">Bank Statement Date :</label>
                                <input
                                    type="text"
                            ...
                            {/* Date of Entry */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">Date of Entry :</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={dateOfEntry}
                            ...
                            <div className="md:col-span-2">
                                <label className="block text-gray-700 font-medium mb-2 text-sm">Chq./DD/TPO/TT/MT/LC/PAY ORDER No. :</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={chqDdNo}
                            ...
                            {/* Bank */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">Bank :</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={bank}
