...
const IncompleteVoucherduetoPowerFailure = ({ isCollapsed = false, activeItem, toggleMobileSidebar = () => { } }) => {
    // Header fields
                ...
                <div className='p-4 sm:p-6'>
                    ...
                    <div className='bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6'>
                        ...
                        <div className="text-center mb-4 sm:mb-6">
                            ...
                            <h1 className="text-xl font-bold text-gray-800 underline mb-4 sm:mb-6">Voucher Entry</h1>
                        </div>
...
export default IncompleteVoucherduetoPowerFailure