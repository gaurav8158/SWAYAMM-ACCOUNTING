                      ...
                      {notifications.map((notification) => {
                        ...
                        return (
                          <div
                            ...
                            className={`px-4 py-3 hover:bg-gray-100 transition-colors duration-150 cursor-pointer border-b border-gray-50 last:border-b-0 group ${
            ...
            <div className="flex items-center space-x-1 md:space-x-2">
              ...
              <div className="relative" ref={notificationRef}>
                ...
                >
                  <Bell
                    size={18}
                    className="md:w-5 md:h-5 transition-transform duration-200 group-hover:animate-pulse"
                  />
                  {unreadCount > 0 && (
                            ...
                            <div className="flex items-start space-x-3">
                              <div className="flex-shrink-0 relative">
                                {notification.avatar ? (
                                  ...
                                  <div
                                    className={`w-10 h-10 rounded-full ${notification.iconBg} flex items-center justify-center`}
                                  >
                                    <IconComponent
                                      size={20}
                                      className="text-white"
                                  ...
                                  <div className="flex-1">
                                    <p
                                      className={`text-sm truncate transition-all duration-200 ${
                                        notification.unread
                                          ? "font-semibold text-gray-800 group-hover:font-bold"
                                          : "font-medium text-gray-600 group-hover:font-semibold group-hover:text-gray-800"
                                      }`}
                                    >
                                      {notification.title}
                                      {notification.subtitle && (
