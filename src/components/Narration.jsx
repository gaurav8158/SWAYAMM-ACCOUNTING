...
const Narration = ({ isCollapsed, activeItem, toggleMobileSidebar }) => {
    ...
    return (
        <>
            <div className={`${isCollapsed ? 'md:ml-20' : 'md:ml-72'} transition-all duration-300 ease-in-out min-h-screen bg-[#EEEEF1]`}>
                <Navbar pageTitle={pageTitles.narration} toggleMobileSidebar={toggleMobileSidebar} />
                ...
                <div className='p-6 sm:px-4 md:px-6 py-1'>
                    <div className='bg-white rounded-lg shadow-sm p-3 sm:p-4 md:p-6'>
                        ...
                        <div className="text-center mb-6">
                            ...
                            <h1 className="text-xl font-bold text-gray-800 mt-4 mb-6">NARRATION</h1>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
                            {/* Transaction Type */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 sm:mb-3 text-sm sm:text-base">Transaction Type</label>
                                <select
                            ...
                            {/* Book */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 sm:mb-3 text-sm sm:text-base">Book</label>
                                <input
                                    type="text"
                                    className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm sm:text-base"
                                    value={bookValue}
                ...
                <div className='p-6 sm:px-4 md:px-6 py-1'>
                    <div className="bg-white rounded-lg p-3 sm:p-6 md:p-8">
                        ...
                        <div className="mb-4 sm:mb-6">
                            ...
                            <div className="block sm:hidden">
                                <div className="mb-3">
                                    <label className="block text-gray-700 font-medium mb-2 text-sm">DB A/C Code</label>
                                    <div className='bg-gray-200 text-gray-700 rounded-xl p-3 font-medium flex items-center'>
                                        {selectedDebitDbAc || "DB A/C Code"}
                                    </div>
                                </div>
                                <div className="mb-4">
                                    <label className="block text-gray-700 font-medium mb-2 text-sm">DB A/C Description</label>
                                    <select
                            ...
                            <div className="hidden sm:block">
                                <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-2">
                                    <label className="block text-gray-700 font-medium text-sm sm:text-base">DB A/C Code</label>
                                    <label className="block text-gray-700 font-medium text-sm sm:text-base">DB A/C Description</label>
                                </div>
                                <div className='flex flex-row gap-3 sm:gap-4 items-center'>
                                    <div className='bg-gray-200 text-gray-700 rounded-xl p-3 sm:min-w-35 font-medium flex items-center'>
                        ...
                        <div className="mb-4 sm:mb-6">
                            ...
                            <div className="block sm:hidden">
                                <div className="mb-3">
                                    <label className="block text-gray-700 font-medium mb-2 text-sm">C & F Code</label>
                                    <div className='bg-gray-200 text-gray-700 rounded-xl p-3 font-medium flex items-center'>
                                        {selectedDebitCF || "C & F Code"}
                                    </div>
                                </div>
                                <div className="mb-4">
                                    <label className="block text-gray-700 font-medium mb-2 text-sm">C & F Description</label>
                                    <select
                                        className='w-full bg-white text-black rounded-xl border border-gray-300 p-3 focus:outline-none focus:ring-2 focus:ring-blue-300'
                            ...
                            <div className="hidden sm:block">
                                <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-2">
                                    <label className="block text-gray-700 font-medium text-sm sm:text-base">C & F Code</label>
                                    <label className="block text-gray-700 font-medium text-sm sm:text-base">C & F Description</label>
                                </div>
                                <div className='flex flex-row gap-3 sm:gap-4 items-center'>
                                    <div className='bg-gray-200 text-gray-700 rounded-xl p-3 sm:min-w-35 font-medium flex items-center'>
                                        {selectedDebitCF || "C & F"}
                ...
                <div className='p-6 sm:px-4 md:px-6 py-1'>
                    <div className="bg-white rounded-lg p-3 sm:p-6 md:p-8">
                        ...
                        <div className="mb-4 sm:mb-6">
                            ...
                            <div className="block sm:hidden">
                                <div className="mb-3">
                                    <label className="block text-gray-700 font-medium mb-2 text-sm">CR A/C Code</label>
                                    <div className='bg-gray-200 text-gray-700 rounded-xl p-3 font-medium flex items-center'>
                                        {selectedCreditCrAc || "CR A/C Code"}
                                    </div>
                                </div>
                                <div className="mb-4">
                                    <label className="block text-gray-700 font-medium mb-2 text-sm">CR A/C Description</label>
                                    <select
                                        className='w-full bg-white text-black rounded-xl border border-gray-300 p-3 focus:outline-none focus:ring-2 focus:ring-blue-300'
                            ...
                            <div className="hidden sm:block">
                                <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-2">
                                    <label className="block text-gray-700 font-medium text-sm sm:text-base">CR A/C Code</label>
                                    <label className="block text-gray-700 font-medium text-sm sm:text-base">CR A/C Description</label>
                                </div>
                                <div className='flex flex-row gap-3 sm:gap-4 items-center'>
                                    <div className='bg-gray-200 text-gray-700 rounded-xl p-3 sm:min-w-35 font-medium flex items-center'>
                ...
                <div className='p-6 sm:px-4 md:px-6 py-1'>
                    <div className="bg-white rounded-lg p-3 sm:p-6 md:p-8">
                        <h2 className="text-lg sm:text-xl font-medium text-gray-800 mb-4 sm:mb-6">Narration Details</h2>
                        <div className="h-px bg-gray-200 mb-6 sm:mb-8"></div>
                        ...
                        <div className="mb-4 sm:mb-6">
                            ...
                            <div className="block sm:hidden">
                                <div className="mb-3">
                                    <label className="block text-gray-700 font-medium mb-2 text-sm">Payment Option Code</label>
                                    <div className='bg-gray-200 text-gray-700 rounded-xl p-3 font-medium flex items-center'>
                                        {selectedPaymentOption || "Payment Option"}
                                    </div>
                                </div>
                                <div className="mb-4">
                                    <label className="block text-gray-700 font-medium mb-2 text-sm">Payment Option Description</label>
                                    <select
                                        className='w-full bg-white text-gray-700 rounded-xl border border-gray-300 p-3 outline-none focus:outline-none focus:ring-2 focus:ring-blue-300'
                            ...
                            <div className="hidden sm:block">
                                <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-2">
                                    <label className="block text-gray-700 font-medium text-sm sm:text-base">Payment Option Code</label>
                                    <label className="block text-gray-700 font-medium text-sm sm:text-base">Payment Option Description</label>
                                </div>
                                <div className='flex flex-row gap-3 sm:gap-4 items-center'>
                                    <div className='bg-gray-200 text-gray-700 rounded-xl p-3 sm:min-w-35 font-medium flex items-center'>
                                        {selectedPaymentOption || "Payment Option"}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
                            {narrationDetails.map((detail, i) => (
                                <div key={i}>
                                    <label className="block text-gray-700 font-medium mb-2 sm:mb-3 text-sm sm:text-base">Detail {i + 1}</label>
                                    <input
                                        type="text"
                                        ...
                                        value={detail}
                                        onChange={(e) => handleNarrationDetailChange(i, e.target.value)}
                                        placeholder="NA"
                                    />
                                </div>
                            ))}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 sm:mb-3 text-sm sm:text-base">Responsible Person</label>
                                <input
                                    type="text"
                                    className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm sm:text-base"
