...
const Journal_Sales_PurchaseVoucherBackDate = ({ isCollapsed = false, activeItem, toggleMobileSidebar = () => { } }) => {
    // Header fields
                ...
                <div className='p-4 sm:p-6'>
                    ...
                    <div className='bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6'>
                        ...
                        <div className="text-center mb-4 sm:mb-6">
                            ...
                            <h1 className="text-xl font-bold text-gray-800 underline mb-4 sm:mb-6">Journal/Sales/Purchase Voucher For Back Date Entry</h1>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4 sm:mb-6">
                            {/* TRAN. TYPE */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">TRAN. TYPE</label>
                                <select
                            ...
                            {/* CASH PAYMENT */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">CASH PAYMENT</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={cashPayment}
                            ...
                            {/* SR NO */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">SR NO.</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={srNo}
                            ...
                            {/* VOUCHER NO */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">VOUCHER NO.</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={voucherNo}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-4 sm:mb-6">
                            {/* VT. DT */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">VT. DT</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={vtDt}
                            ...
                            {/* VOUCHER TYPE */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">VOUCHER TYPE</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={voucherType}
                            ...
                            {/* CASH VOUCHER */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">CASH VOUCHER</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={cashVoucher}
                            ...
                            {/* NO */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">NO</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={noField}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-5 gap-4 mb-4 sm:mb-6">
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">NE</label>
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                    value={neField}
                        ...
                        {/* Print Options */}
                        <div className="mb-4 sm:mb-6">
                            <label className="block text-gray-700 font-medium mb-3 text-sm">Print Options</label>
                            <div className="flex flex-wrap gap-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    />
                                    <label htmlFor="printMemo" className="text-sm text-gray-700 font-medium">PRINT MEMO</label>
                                </div>
                                {/* <div className="flex items-center gap-2">
                                    <input
                                        type="checkbox"
                                        ...
                                        className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                                    />
                                    <label htmlFor="vide" className="text-sm text-gray-700 font-medium">VIDE</label>
                                </div> */}
                                <div className="flex items-center gap-2">
                                    <input
                                        type="checkbox"
                                        ...
                                        className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                                    />
                                    <label htmlFor="advice" className="text-sm text-gray-700 font-medium">ADVICE</label>
                                </div>
                                <div className="flex items-center gap-2">
                                    <input
                                        type="checkbox"
                                        ...
                                        className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                                    />
                                    <label htmlFor="challan" className="text-sm text-gray-700 font-medium">CHALLAN</label>
                                </div>
                                <div className="flex items-center gap-2">
                                    <input
                                        type="checkbox"
                                        ...
                                        className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                                    />
                                    <label htmlFor="invoice" className="text-sm text-gray-700 font-medium">INVOICE</label>
                                </div>
                                <div className="flex items-center gap-2">
                                    <input
                                        type="checkbox"
                                        ...
                                        className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                                    />
                                    <label htmlFor="voucher" className="text-sm text-gray-700 font-medium">VOUCHER</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
                            <h2 className="text-lg font-medium text-gray-800 mb-2 sm:mb-0">DR</h2>
                            <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-gray-600">
                                    <div className="flex items-start gap-2">
                                        ...
                                        <input type="text" className="flex-grow px-1 py-0.5 border border-gray-300 rounded-sm text-black text-xs" placeholder="0" value={debitLedger} readOnly />
                                    </div>
                                    <div className="flex items-start gap-2">
                                        <span className="sm:hidden">PROFIT & LOSS</span>
                                        <input type="text" className="flex-grow px-1 py-0.5 border border-gray-300 rounded-sm text-black text-xs" placeholder="0" value={debitProfitLoss} readOnly />
                                    </div>
                                    <div className="flex items-start gap-2">
                                        <span className="sm:hidden">BALANCE SHEET</span>
                                        <input type="text" className="flex-grow px-1 py-0.5 border border-gray-300 rounded-sm text-black text-xs" placeholder="0" value={debitBalanceSheet} readOnly />
                                    </div>
                                    <div className="flex items-start gap-2">
                                        <span className="sm:hidden">CASH FLOW</span>
                                        <input type="text" className="flex-grow px-1 py-0.5 border border-gray-300 rounded-sm text-black text-xs" placeholder="0" value={debitCashFlow} readOnly />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mb-4 sm:mb-6 border-b pb-4">
                            <div className='grid grid-cols-1 sm:grid-cols-9 gap-y-4 sm:gap-4 items-center text-sm'>
                                <div className="sm:col-span-1">
                                    <label className="block text-gray-700 font-medium mb-1 sm:hidden">S.NO</label>
                                    <span className="text-gray-600">1</span>
                                </div>
                                <div className="sm:col-span-2 flex flex-col sm:flex-row items-start sm:items-center gap-1">
                                    <label className="block text-gray-700 font-medium sm:hidden">A/C CODE</label>
                                    <input
                                ...
                                <div className="sm:col-span-2 flex flex-col sm:flex-row items-start sm:items-center gap-1">
                                    <label className="block text-gray-700 font-medium sm:hidden">A/C HEAD</label>
                                    <input
                                ...
                                <div className="sm:col-span-1 flex flex-col sm:flex-row items-start sm:items-center gap-1">
                                    <label className="block text-gray-700 font-medium sm:hidden">AMOUNT</label>
                                    <input
                                        className='w-full bg-white text-black rounded-lg border border-gray-300 p-2 focus:outline-none focus:ring-2 focus:ring-blue-300 text-sm'
                                        placeholder='Amount'
                                        value={debitAmount}
                                ...
                                <div className="sm:col-span-1 flex flex-col sm:flex-row items-start sm:items-center gap-1">
                                    <label className="block text-gray-700 font-medium sm:hidden">REF. DT.</label>
                                    <input
                                        className='w-full bg-white text-black rounded-lg border border-gray-300 p-2 focus:outline-none focus:ring-2 focus:ring-blue-300 text-sm'
                                        placeholder='Ref. Dt.'
                                        value={debitRefDt}
                                ...
                                <div className="sm:col-span-1 flex flex-col sm:flex-row items-start sm:items-center gap-1">
                                    <label className="block text-gray-700 font-medium sm:hidden">REF. NO.</label>
                                    <input
                                        className='w-full bg-white text-black rounded-lg border border-gray-300 p-2 focus:outline-none focus:ring-2 focus:ring-blue-300 text-sm'
                                        placeholder='Ref. No.'
                                        value={debitRefNo}
                                ...
                                <div className="sm:col-span-1 flex flex-col sm:flex-row items-start sm:items-center gap-1">
                                    <label className="block text-gray-700 font-medium mb-1 sm:hidden">For FDR CHANGE</label>
                        ...
                        <div className="flex justify-end mt-4">
                            <div className="flex items-center gap-2">
                                <span className="text-sm font-medium text-gray-700">DEBIT TOTAL</span>
                                <input
                                    type="text"
                    ...
                    <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
                            <h2 className="text-lg font-medium text-gray-800 mb-2 sm:mb-0">CR</h2>
                            <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-gray-600">
                                    <div className="flex items-start gap-2">
                                        <span className="sm:hidden">LEDGER</span>
                                        <input type="text" className="flex-grow px-1 py-0.5 border border-gray-300 rounded-sm text-black text-xs" placeholder="0" value={creditLedger} readOnly />
                                    </div>
                                    <div className="flex items-start gap-2">
                                        <span className="sm:hidden">PROFIT & LOSS</span>
                                        <input type="text" className="flex-grow px-1 py-0.5 border border-gray-300 rounded-sm text-black text-xs" placeholder="0" value={creditProfitLoss} readOnly />
                                    </div>
                                    <div className="flex items-start gap-2">
                                        <span className="sm:hidden">BALANCE SHEET</span>
                                        <input type="text" className="flex-grow px-1 py-0.5 border border-gray-300 rounded-sm text-black text-xs" placeholder="0" value={creditBalanceSheet} readOnly />
                                    </div>
                                    <div className="flex items-start gap-2">
                                        <span className="sm:hidden">CASH FLOW</span>
                                        <input type="text" className="flex-grow px-1 py-0.5 border border-gray-300 rounded-sm text-black text-xs" placeholder="0" value={creditCashFlow} readOnly />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mb-4 sm:mb-6 border-b pb-4">
                            <div className='grid grid-cols-1 sm:grid-cols-9 gap-y-4 sm:gap-4 items-center text-sm'>
                                ...
                                <div className="sm:col-span-1 flex flex-col sm:flex-row items-start sm:items-center gap-1">
                                    <label className="block text-gray-700 font-medium mb-1 sm:hidden">CHANGE</label>
                                    <div className="w-full bg-gray-100 border border-gray-300 h-10 rounded-lg"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6">
                        <h2 className="text-lg font-medium text-gray-800 mb-4">Narration</h2>
                        <div className="h-px bg-gray-200 mb-4 sm:mb-6"></div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            {/* Left Side - Narration */}
                            <div>
                                <label className="block text-gray-700 font-medium mb-2 text-sm">NARRATION :</label>
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-gray-700 font-medium mb-2 text-sm">CASH IN HAND:</label>
                                    <input
                                        type="text"
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black text-sm"
                                        value={cashInHand}
                                ...
                                <div>
                                    <label className="block text-gray-700 font-medium mb-2 text-sm">ENCLOSURES :</label>
                                    <textarea
...
export default Journal_Sales_PurchaseVoucherBackDate